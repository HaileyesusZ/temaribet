    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="row title_wrapper">
                <h3 id="title">Successful Password Reset</h3>
            </div>
            ...
            <div class="row" id="hero_container_wrapper_for_signup">
                ...
                <div class="row" id="whole_wrapper">
                    <div class ="form_wrapper col-sm-12">
                            <img src="${avatar}" class="img img-circle img-responsive icon" />
                            <h3><span class="text-success fa fa-check-circle fa-lg"></span> Congratulations ${firstName}, you are back to Temaribet.</h3>
                            <h3>Go to your <a href="/Temaribet" style='text-decoration: none'>Home Page</a> and try to sign in</h3>
